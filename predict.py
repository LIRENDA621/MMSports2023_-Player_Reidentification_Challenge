...
class Configuration:
    ...
    # checkpoints: str = 'model/ViT-L-14_openai/fold-1_seed_1/weights_e4.pth'
    checkpoints: str = "model/eva02_large_patch14_448.mim_m38m_ft_in22k_in1k/fold-1_seed_1_paperuse/weights_e4.pth"
    
    # Dataset
    data_dir: str = "data_reid"
...
for checkpoint in checkpoints: 
    ...
    df_challenge = pd.read_csv("challenge_df.csv")
    ...
    # compute distance matrix 这里的test_dataset是无序的

    #-------------------------------
    with open('ckp/test_fea_dic.pkl', 'wb') as f:
    ...
    # save with my-re-ranking
    save_path = '{}/challenge_dmat_my_rerank.csv'.format("/".join(checkpoint.split("/")[:-1]))
    print("write distance matrix:", save_path)
    write_mat_csv(save_path,
                  dist_matrix_rerank_my,
                  challenge_dataset.query,
                  challenge_dataset.gallery)
