...
class Configuration:
    ...
    model: str = 'resnet50.tv2_in1k'   # ('name of Clip model', 'name of dataset') | 'name of Timm model'
    ...
    # Learning Rate
    lr: float = 0.0004                   # use 4 * 10^-5 for ViT | 4 * 10^-4 for CNN
    ...
    prob_flip: str = 0.0                  # probability for random horizontal flip during training 
         
    # Savepath for model checkpoints
    # model_path: str = "./model"
    model_path: str = "model"

    save_base: str = 'infonce_loss'
